...
struct _DDC_UDL_DEVICE_CONTEXT
{
    ...
    DDC_EVENT waitqueueArinc429VoltageMonitoring;                               /* VoltageMonitoring wait queue: one for the board  */
    ...
    DDC_EVENT waitqueueARINC717RxFrame[MAX_NUM_717_PROG_CHANNELS];          /* ARINC717RxFrame wait queue  */
    ...
    DDC_EVENT waitqueueARINC717TxFrame[MAX_NUM_717_PROG_CHANNELS];          /* ARINC717TxFrame wait queue  */
