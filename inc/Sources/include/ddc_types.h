...
typedef struct __attribute__((__packed__)) _HWVERSIONINFO
{
    U32BIT dwFwVersion;
    U32BIT dwHdlVersion;
...
typedef struct __attribute__((__packed__)) _DEV_INFO
{
    U32BIT dwVendorID;
    U32BIT dwDeviceID;
    U32BIT dwBusHub;
...
typedef struct __attribute__((__packed__)) _CHANCOUNT
{
    U8BIT bTx;
    U8BIT bRx;
    U8BIT bGroup;
...
typedef struct __attribute__((__packed__)) _ENHANCED_CAPABILITY_INFO
{
     U8BIT modelNumber;
...
typedef struct __attribute__((__packed__)) _DEV_FEATURE_STATUS_INFO
{
    BOOLEAN bBcDisable;
...
typedef struct __attribute__((__packed__)) _FLASH_INFO
{
    U32BIT StartAddress;
    U32BIT SectorCount;
...
typedef struct _ACEX_IO_CONFIGURE_TYPE
{
    ...
    void (*ioExternalIsr)(S16BIT s16DevNum, U32BIT u32IrqStatus);
...
#define BYTE_ORDER_L(i)                 \
       ((((i) & 0xFF000000) >> 24) |    \
        (((i) & 0x00FF0000) >> 8) |     \
        (((i) & 0x0000FF00) << 8) |     \
        (((i) & 0x000000FF) << 24))

#define BYTE_ORDER_S(i) ((((i) & 0xFF00) >> 8) | (((i) & 0x00FF) << 8))

#define WORD_ORDER_L(i)                 \
    ((((i) & 0x0000FFFF) << 16) |       \
     (((i) & 0xFFFF0000) >> 16))

#else

#define BYTE_ORDER_L(i) (i)
#define WORD_ORDER_L(i) (i)
#define BYTE_ORDER_S(i) (i)

#endif /* defined (PPC) || defined(_powerpc_) */
