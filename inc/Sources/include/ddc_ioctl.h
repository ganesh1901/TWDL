...
typedef struct _DDC_IOCTL_INFO_TYPE
{
    unsigned long u32InputBufferLength; /* size of the IOCTL command being passed */
    unsigned long pOutBuffer;           /* pointer to the output buffer */
    unsigned long u32OutBufferSize;     /* output buffer size */
    unsigned long pu32BytesReturned;    /* number of bytes returned in the output buffer */
    long status;                        /* set to status value returned by IOCTL */
...
typedef struct _DDC_IOCTL_PARAMS
{
    ...
    DDC_IOCTL_INFO_TYPE sIoctlInfo;

} DDC_IOCTL_PARAMS;


typedef struct _DDC_COMPAT_IOCTL_INFO_TYPE
{
    unsigned int u32InputBufferLength;        /* size of the IOCTL command being passed */
    unsigned int pOutBuffer;                  /* pointer to the output buffer */
    unsigned int u32OutBufferSize;            /* output buffer size */
    unsigned int pu32BytesReturned;           /* number of bytes returned in the output buffer */
    int          status;                      /* set to status value returned by IOCTL */

} DDC_COMPAT_IOCTL_INFO_TYPE;

typedef struct _DDC_COMPAT_IOCTL_PARAMS
{
    ...
    DDC_COMPAT_IOCTL_INFO_TYPE sIoctlInfo;

} DDC_COMPAT_IOCTL_PARAMS;

/* ========================================================================== */
/* IOCTL Group Definitions                                                    */
/* ========================================================================== */

#define DDC_IOCTL_GROUP_DEVICE              0
#define DDC_IOCTL_GROUP_I_O_SERIAL          1
#define DDC_IOCTL_GROUP_EMA_E2MA            2
#define DDC_IOCTL_GROUP_1553                3
#define DDC_IOCTL_GROUP_1553_BC             4
#define DDC_IOCTL_GROUP_1553_RT             5
#define DDC_IOCTL_GROUP_1553_MT             6
#define DDC_IOCTL_GROUP_ARINC               7
...
#define IOCTL_REG_READ                          DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 11, METHOD_BUFFERED) /* <UDL14> */
#define IOCTL_REG_READ32                        DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 12, METHOD_BUFFERED) /* <UDL14> */
#define IOCTL_REG_READ_BLK                      DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 13, METHOD_OUT_DIRECT)
#define IOCTL_REG_WRITE                         DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 14, METHOD_BUFFERED) /* <UDL14> */
#define IOCTL_REG_WRITE32                       DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 15, METHOD_BUFFERED) /* <UDL14> */
#define IOCTL_REG_WRITE_BLK                     DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 16, METHOD_IN_DIRECT)

#define IOCTL_MEM_READ                          DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 17, METHOD_BUFFERED) /* <UDL14> */
#define IOCTL_MEM_READ32                        DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 18, METHOD_BUFFERED) /* <UDL14> */
#define IOCTL_MEM_READ_BLK                      DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 19, METHOD_OUT_DIRECT)
#define IOCTL_MEM_WRITE                         DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 20, METHOD_BUFFERED) /* <UDL14> */
#define IOCTL_MEM_WRITE32                       DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 21, METHOD_BUFFERED) /* <UDL14> */
#define IOCTL_MEM_WRITE_BLK                     DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 22, METHOD_IN_DIRECT)

#define IOCTL_BLK_READ                          DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 23, METHOD_BUFFERED) /* <UDL14> */
#define IOCTL_BLK_WRITE                         DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 24, METHOD_IN_DIRECT) /* <UDL14> */
...
#define IOCTL_GET_CAPABILITIES                  DDC_IOCTL(DDC_IOCTL_GROUP_DEVICE, 47, METHOD_BUFFERED) /* <UDL15> */
...
#define IOCTL_ARINC_DD429X_COMMAND              DDC_IOCTL(DDC_IOCTL_GROUP_ARINC, 20, METHOD_BUFFERED)
