...
{
    HANDLE           hDriverApp;           /* Handle to Linux device */
...
//todo - remove - typedef enum _DDC_FAMILY
//todo - remove - {
//todo - remove -     DDC_EMACE = 0,
//todo - remove -     DDC_E2MACE,
//todo - remove -     DDC_ACEX
//todo - remove - } DDC_FAMILY;
...
S16BIT _dvxLinuxInstallIrq(S16BIT DevNum);

S16BIT _dvxLinuxUninstallIrq(S16BIT DevNum);
...
S16BIT _DECL _dvxSetMTRespTimeOut
(
    S16BIT s16DevNum,
    U32BIT u32RespTimeOut
);
...
BOOLEAN ddcDeviceIoControl
(
    DDC_HANDLE hDriver,
    U32BIT u32IoCtlCode,
    DDC_IOCTL_PARAMS *pIoCtlCmd,
    U32BIT u32IoCtlCmdSize,
    VOID* pOutBuffer,
...
(
    ...
    void(_DECL *pfDioTtIsr)(S16BIT DevNum, U32BIT u32IntSts)
);
