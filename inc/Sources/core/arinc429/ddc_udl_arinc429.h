...
#define DD429_GENERAL_COMMAND__INDEX_END                    (DD429_GENERAL_COMMAND__INDEX_START + 5) /* MAKE SURE THIS VALUE IS ALWAYS THE SAME AS THE LAST DEFINED ITEM */
...
#define DD429_TX_COMMAND__INDEX_END                         (DD429_TX_COMMAND__INDEX_START + 9) /* MAKE SURE THIS VALUE IS ALWAYS THE SAME AS THE LAST DEFINED ITEM */
...
#define DD429_TESTER_COMMAND__INDEX_END                     (DD429_TESTER_COMMAND__INDEX_START + 28) /* MAKE SURE THIS VALUE IS ALWAYS THE SAME AS THE LAST DEFINED ITEM */
...
#define REPEATER_MODE__DISABLED          0x00000000    /* Don’t repeat data */
#define REPEATER_MODE__REPEAT            0x00010000    /* Repeat the exact data received */
#define REPEATER_MODE__DATA_REPLACE      0x00020000    /* Replace the data portion of the message */
#define REPEATER_MODE__LABEL_REPLACE     0x00030000    /* Replace the label portion of the message */
#define REPEATER_MODE__MESSAGE_REPLACE   0x00040000    /* Replace any portion of the message */
#define REPEATER_MODE__DATA_FLIP         0x00050000    /* Flip the data portion of the message. A value of 1 means to flip the received bit */
#define REPEATER_MODE__LABEL_FLIP        0x00060000    /* Flip the label portion of the message. A value of 1 means to flip the received bit */
#define REPEATER_MODE__MESSAGE_FLIP      0x00070000    /* Flip any portion of the message. A value of 1 means to flip the received bit */
#define REPEATER_MODE__DATA_SET          0x00080000    /* Set the data portion of the message. A value of 1 means to set the received bit */
#define REPEATER_MODE__LABEL_SET         0x00090000    /* Set the label portion of the message. A value of 1 means to set the received bit */
#define REPEATER_MODE__MESSAGE_SET       0x000A0000    /* Set any portion of the message. A value of 1 means to set the received bit */
#define REPEATER_MODE__DATA_CLEAR        0x000B0000    /* Clear the data portion of the message. A value of 1 means to clear the received bit */
#define REPEATER_MODE__LABEL_CLEAR       0x000C0000    /* Clear the label portion of the message. A value of 1 means to clear the received bit */
#define REPEATER_MODE__MESSAGE_CLEAR     0x000D0000    /* Clear any portion of the message. A value of 1 means to clear the received bit */
#define REPEATER_MODE__MAX               REPEATER_MODE__MESSAGE_CLEAR

#define REPEATER_OPTION__LABEL_ONLY      0x10000000    /* Use the specified mode on a by label basis. Bits 31 - 8 are Data. Bits 8 - 0 are Label. */
#define REPEATER_OPTION__LABEL_SDI       0x20000000    /* Use the specified mode on a by label/SDI basis. Bits 31 - 10 are Data. Bits 9 - 0 are Label/SDI. */

/* Data Repeater */
/* HARDWARE/INTERNAL Mode Values */
#define REPEATER_DISABLED_HW          0x0000
#define REPEATER_REPEAT_HW            0x0001
#define REPEATER_DATA_REPLACE_HW      0x0002
#define REPEATER_LABEL_REPLACE_HW     0x0003
#define REPEATER_MESSAGE_REPLACE_HW   0x0004
#define REPEATER_MESSAGE_FLIP_HW      0x0005
#define REPEATER_MESSAGE_SET_HW       0x0006
#define REPEATER_MESSAGE_CLEAR_HW     0x0007
#define REPEATER_LABEL_ONLY_HW        0x0000
#define REPEATER_LABEL_SDI_HW         0x8000

#define REPEATER_LABEL_DATA_SHIFT     8
#define REPEATER_LABELSDI_DATA_SHIFT  10
#define DD429_REPEATER_MODE_OFFSET    1024
/* Data Repeater */
