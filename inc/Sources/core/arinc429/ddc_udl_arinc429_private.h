...
typedef struct _ACEX_429_RX_TYPE
{
    ...
    DDC_EVENT waitqueueARINC429RxFifo;                /* ARINC429RxFifo wait queue: one for each channel  */
...
typedef struct _ACEX_429_TX_TYPE
{
    ...
    DDC_EVENT waitqueueARINC429SetTxFrameControl;       /* ARINC429SetTxFrameControl wait queue: one for each channel */
...
#define MAX_NUM_LABEL_SDI                               0x0400 /* 1024 lable/SID combinations, including invalid ones */
