...
{
    U32BIT u32Discrete = pIoctlParams->Param1;
    U32BIT u32RegValue;
    ...
    {
        dbg_print(DBG_MODULE_IOCTL, DBG_PRIORITY_ERROR, "GetAioOutput: ch%d AVIONIC_HIGH, 0x%08x\n", u32Discrete, u32RegValue);
        return AVIONIC_HIGH;
    }
    else
    {
        dbg_print(DBG_MODULE_IOCTL, DBG_PRIORITY_ERROR, "GetAioOutput: ch%d AVIONIC_LOW, 0x%08x\n", u32Discrete, u32RegValue);
        return AVIONIC_LOW;
    }
}
...
)
{
    ...
    {
        dbg_print(DBG_MODULE_IOCTL, DBG_PRIORITY_ERROR, "GetAioDirection: ch%d AVIONIC_OUTPUT, 0x%08x\n", u32Discrete, u32RegValue);
        return AVIONIC_OUTPUT;
    }
    else
    {
        dbg_print(DBG_MODULE_IOCTL, DBG_PRIORITY_ERROR, "GetAioDirection: ch%d AVIONIC_INPUT, 0x%08x\n", u32Discrete, u32RegValue);
...
)
{
    ...
    if (u32RegValue & DDC_UDL_AIO_STATE_BIT[u32Discrete - 1])
    {
        dbg_print(DBG_MODULE_IOCTL, DBG_PRIORITY_ERROR, "GetAioInput: ch%d AVIONIC_HIGH, 0x%08x\n", u32Discrete, u32RegValue);
        return AVIONIC_HIGH;
    }
    else
    {
        dbg_print(DBG_MODULE_IOCTL, DBG_PRIORITY_ERROR, "GetAioInput: ch%d AVIONIC_LOW, 0x%08x\n", u32Discrete, u32RegValue);
        return AVIONIC_LOW;
    }
}
...
)
{
    ...
    /* read in DIO register value */
    AioRegRead(pDeviceContext, &u32RegValue);
    dbg_print(DBG_MODULE_IOCTL, DBG_PRIORITY_ERROR, "GetAioAll: 0x%08x\n", u32RegValue);
...
{
    U32BIT u32Discrete = pIoctlParams->Param1;
    U32BIT level = pIoctlParams->Param2;
    U32BIT u32RegValue;
    ...
    dbg_print(DBG_MODULE_IOCTL, DBG_PRIORITY_ERROR, "SetAioOutput: ch%d 0x%08x\n", u32Discrete, u32RegValue);
...
)
{
    ...
    /* Write to AIO register.
     * AIO register WORD address, 0x41D << 1 */
    dbg_print(DBG_MODULE_IOCTL, DBG_PRIORITY_ERROR, "SetAioDirection: ch%d 0x%08x\n", u32Discrete, u32RegValue);
    AioRegWrite(pDeviceContext, u32RegValue);
...
)
{
    ...
    /* Write to AIO register */
    dbg_print(DBG_MODULE_IOCTL, DBG_PRIORITY_ERROR, "SetAioAll: 0x%08x\n", u32RegValue);
    AioRegWrite(pDeviceContext, u32RegValue);
}
