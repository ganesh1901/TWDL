...
typedef struct _DDC_REMOTE_DEVICE_INFO
{
    ...
    DDC_THREAD      hRespDispatcherThread;
    DDC_HANDLE      u32RespDispatcherThreadID;
    BOOLEAN         bClientMsgDispatcherUp;

    DDC_SOCKET      IrqListenSock;
    DDC_THREAD      hIrqListenThread;
    DDC_HANDLE      u32IrqListenThreadID;
    
    DDC_HANDLE      h_dvrClientMsgDispatcher;
    DDC_HANDLE      u32_dvrClientMsgDispatcherID;

    BOOLEAN         bIrqListenerUp;

    DDC_THREAD      hIrqProcThread;
    DDC_HANDLE      u32IrqProcThreadID;
    BOOLEAN         bIrqProcUp;
