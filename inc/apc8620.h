...
typedef unsigned int CSTATUS;

#define TRUE_1	1	/* Boolean value for TRUE_1 */
#define FALSE_1	0	/* Boolean value for false */
...
#define E_OUT_OF_PMCS	    0x8002	/*  All carrier spots have been taken */
